...
ClassImp(MiptDoubleGaussian2); 

 MiptDoubleGaussian2::MiptDoubleGaussian2(const char *name, const char *title, 
                        RooAbsReal& _x,
                        RooAbsReal& _mean,
                        RooAbsReal& _frac2,
                        RooAbsReal& _mpeak,
 ...
 MiptDoubleGaussian2::MiptDoubleGaussian2(const MiptDoubleGaussian2& other, const char* name) :  
 ...
 Double_t MiptDoubleGaussian2::evaluate() const 
 { 
   // ENTER EXPRESSION IN TERMS OF VARIABLE ARGUMENTS HERE 
   double res = 0;
   if ((mpeak - mth) < 0.000001) return res;
   double sigma1 = MiptSigma(mpeak, mth, w1, beta);
   double sigma2 = MiptSigma(mpeak, mth, w2, beta);
